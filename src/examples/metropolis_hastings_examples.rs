...
pub fn run_business_example() {
    ...
    // ｎ回の観測データ（顧客の購入金額-ドル）
    // let observations = vec![41.0, 47.0, 57.0, 66.0, 49.0, 28.0, 47.0, 58.0, 54.0, 51.0]; // スプシで乱数から生成した値
    let observations = vec![41.0, 47.0, 57.0, 66.0, 49.0, 28.0, 47.0, 58.0, 54.0, 51.0, 51.0, 45.0, 44.0, 56.0, 61.0, 60.0, 51.0, 48.0, 57.0, 48.0]; // スプシで乱数から生成した値
    //    let observations = vec![50.0, 60.0, 55.0, 65.0, 70.0]; // 適当
